...
public class LancamentoServiceTest {
	...
	@Test
	public void testBuscarLacamentoPorFuncionarioId() {
		Page<Lancamento> lacamento = this.lancamentoService.buscarPorFuncionarioId(1L, new PageRequest(0,  10));
		assertNotNull(lacamento);
	}
	
	
	@Test
	public void testBuscarLacamentoPorId() {
	...
	@Test
	public void testPersistirLacamento() {
